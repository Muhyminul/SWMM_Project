...
def Save_file():
    ...
    for i in range(len(g)):
        ...
        X_Coord.append(float(all_coords[0]))
        Y_Coord.append(float(all_coords[1]))
    ...
    for i in range(len(g)):
        ...
        # print(all_coords)
        try:
            near_X_Coord.append(float(all_coords[0][0]))
            near_Y_Coord.append(float(all_coords[0][1]))
        except:
            near_X_Coord.append(float(all_coords[0]))
            near_Y_Coord.append(float(all_coords[1]))
    ...
    for i in range(len(g)):
        ...
        for j in range(len(coor) - 1):
            new_coor = coor[j]
            X_Coord.append(float(new_coor[0]))
            Y_Coord.append(float(new_coor[1]))
            Subcatchment.append('S' + str(i + 1))
    ...
    for i in range(len(g)):
        ...
        try:
            X_Coord.append(float(all_coords[0][0]))
            Y_Coord.append(float(all_coords[0][1]))
        except:
            X_Coord.append(float(all_coords[0][0]))
            Y_Coord.append(float(all_coords[0][1]))
    ...
    for i in range(len(df_3)):
        ...
        *_, (x_e, y_e) = linestring.coords
        ...
        x_strt.append(float(x_s))
        y_strt.append(float(y_s))
        x_end.append(float(x_e))
        y_end.append(float(y_e))
